              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.success = new java.util.HashSet<BookDto>(2*_set26.size);
                  @org.apache.thrift.annotation.Nullable BookDto _elem27;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, finBooksByAuthor_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (BookDto _iter29 : struct.success)
            {
              _iter29.write(oprot);
            }
            oprot.writeSetEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (BookDto _iter30 : struct.success)
            {
              _iter30.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.HashSet<BookDto>(2*_set31.size);
            @org.apache.thrift.annotation.Nullable BookDto _elem32;
